...
struct Quaternion {
    ...
    init(angle: Float32, axis: Vector3) {
        ...
        fromAngleAxis(angle: angle, axis: axis)
    }
}
...
extension Quaternion {
    ...
    mutating func rotate( v: inout Vector3) {
    ...
    func inverseRotate( v: inout Vector3) {
    ...
    func rot(v: Vector3) -> Vector3 {
        ...
        let crossDot = (qv.cross(other: v)) * w + qv * (qv.dot(v: v))
