...
extension Matrix33 {
    ...
    func toQuat( q:inout Quaternion) {
    ...
    func getColumn(col:Int, v:inout Vector3) {
    ...
    func getRow(row:Int, v:inout Vector3) {
...
//    
//        swapValues(a: &self[0,1], b: &self[1,0])
//        swapValues(a: &self[1,2], b: &self[2,1])
//        swapValues(a: &self[0,2], b: &self[2,0])
//    }
    ...
    func multiplyByTranspose(src: Vector3, dst: inout Vector3) {
    ...
    func getInverse( dest: inout Matrix33) -> Bool {
    ...
    func getColumnMajor( rawMatrix: inout Matrix3x3) {
    ...
    func gerRowMajor( rawMatrix: inout Matrix3x3) {
    ...
    func getColumnMajorStride4( rawMatrix: inout Matrix4x4) {
    ...
    func getRowMajorStride4( rawMatrix: inout Matrix4x4) {
...
func * (left: Matrix33, right: Matrix33) -> Matrix33 {
    ...
    outMatrix.multiply(left: left, right: right)
...
func * (left: Matrix33, right: Vector3) -> Vector3 {
    ...
    left.multiply(src: right, dst: &dest)
    
    return dest
}

func += ( left: inout Matrix33, right: Matrix33) {
