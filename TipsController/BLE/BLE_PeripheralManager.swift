...
let peripheralName = "TIPSBTE"
// Service
let BLEService = "366DEE95-85A3-41C1-A507-8C3E02342000" // generic service

// Characteristics
let CH_READ  = "366DEE95-85A3-41C1-A507-8C3E02342001"
let CH_WRITE = "366DEE95-85A3-41C1-A507-8C3E02342002"
...
class BLEPeripheralManager : NSObject, CBPeripheralManagerDelegate {
    ...
    //
    func setReadable(_ readableString: String) {
        if( self.notifyCharac != nil )
        {
            let data: Data = readableString.data(using: String.Encoding.utf8)!
...
//            self.notifyValueTimer = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(self.notifyValue), userInfo: nil, repeats: true)
        }
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager, didReceiveRead request: CBATTRequest) {
        ...
        let data: Data = TextToAdvertise.data(using: String.Encoding.utf8)!
